...
public class MainMap extends AppCompatActivity implements OnMapReadyCallback, AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    GoogleMap mMap;
    float zoom = 17;
    String[] arMapak;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (arMap==null){
            Intent intent = new Intent(MainMap.this, NotInterNet.class);
