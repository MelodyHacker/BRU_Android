...
//    public String jsonnews = "http://10.0.2.2/bru/JsonNews.php";
//    public String imgnew = "http://10.0.2.2/bru/upload/news/";
//    public String jsonporiline = "http://10.0.2.2/bru/JsonPorilines.php";
//    public String jsonplace = "http://10.0.2.2/bru/JsonPlaces.php";
...
//
    ...
    public String report = "https://tanonexecutioner.000webhostapp.com/Report.php";
    public String jsonnews = "https://tanonexecutioner.000webhostapp.com/JsonNews.php";
    public String imgnew = "https://tanonexecutioner.000webhostapp.com/upload/news/";
    public String jsonporiline = "https://tanonexecutioner.000webhostapp.com/JsonPorilines.php";
    public String jsonplace = "https://tanonexecutioner.000webhostapp.com/JsonPlaces.php";
